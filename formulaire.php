...
<body>
    ...
    <div class="form-txt" action="inser_res.php" method="post">
    <form class="form">
        <div class="form-group">
            <label class="form-label" for="name">Prénom :</label>
            <input required="" placeholder="Prénom" class="form-input" type="text">
        </div>
        <div class="form-group">
            <label class="form-label" for="name">Nom de famille :</label>
            <input required="" placeholder="Nom" class="form-input" type="text">
        </div>
        <div class="form-group">
